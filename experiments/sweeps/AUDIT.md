...
| item | how | status |
|---|---|---|
| Why binding needs ~300 episodes -- track decodability *during* training, not only at the end | new probe | **the live question.** Sweep 018 ruled out rescheduling inside a fixed budget; this asks whether the mechanism is genuinely slow or the readout is |
